...
class LoveFoodScraper:
    ...
    def _get_love_food_info(self):
        ...
        dict_stock_item = response["element"]["StoreStockItem"]["CategoryStockItems"]
    ...
    def _to_list_stock_item(self, item_list):
        ...
        for stock_item in item_list:
            list_item.append(
                store.StockItem(stock_item["ItemName"], stock_item["RemainingQty"])
            )
        return list_item
    ...
    def to_list(self):
        ...
        for category_stock_item in self._dict_stock_item:
            ...
            list_item = self._to_list_stock_item(category_stock_item["ItemList"])
